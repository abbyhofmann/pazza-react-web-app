...
const ViewPostPage = () => {
    ...
    useEffect(() => {
        ...
        setPost({ _id: postId!, folderId: 'fid', authorId: 'aid', datePosted: '2025-02-15T09:30:00.000Z', type: 0, instructor: 1, title: 'Web Dev', content: 'Build cool web apps', followUpQuestions: '', studentResponse: '', instructorResponse: '', viewers: '', courseId: '4550'});
      }, [postId]);
